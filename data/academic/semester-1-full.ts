...
const configs: LessonConfig[] = [
  ...
  },
  {
    ...
    concepts: [
      { title: "Hai cạnh góc vuông", summary: "Nếu hai cạnh góc vuông tương ứng của hai tam giác vuông bằng nhau thì hai tam giác vuông bằng nhau.", keyIdeas: ["hai cạnh góc vuông", "góc xen giữa 90°", "c.g.c"], prerequisites: ["Tam giác vuông", "c.g.c"], reps: ["DIAGRAM"] },
      { title: "Cạnh góc vuông và góc nhọn kề", summary: "Nếu một cạnh góc vuông và góc nhọn kề cạnh ấy tương ứng bằng nhau thì hai tam giác vuông bằng nhau.", keyIdeas: ["cạnh góc vuông", "góc nhọn kề"], prerequisites: ["Tam giác vuông", "g.c.g"], reps: ["DIAGRAM"] },
      { title: "Cạnh huyền và góc nhọn", summary: "Nếu cạnh huyền và một góc nhọn tương ứng bằng nhau thì hai tam giác vuông bằng nhau.", keyIdeas: ["cạnh huyền", "góc nhọn"], prerequisites: ["Tam giác vuông", "g.c.g"], reps: ["DIAGRAM"] },
    ...
    objectives: ["Nhận biết và phân biệt các trường hợp bằng nhau của tam giác vuông.", "Vận dụng đúng dữ kiện cạnh/góc tương ứng để chọn trường hợp.", "Lập luận chứng minh trong cấu hình tam giác vuông."],
  ...
  },
  {
    ...
    concepts: [
      { title: "Tam giác cân và định lí đảo", summary: "Tam giác cân có hai góc ở đáy bằng nhau; ngược lại, tam giác có hai góc bằng nhau thì là tam giác cân.", keyIdeas: ["hai cạnh bằng nhau", "hai góc ở đáy bằng nhau", "định lí đảo"], prerequisites: ["Tam giác"], reps: ["DIAGRAM", "TEXT"] },
      { title: "Tam giác đều", summary: "Tam giác đều có ba cạnh bằng nhau và ba góc bằng nhau, mỗi góc bằng 60°.", keyIdeas: ["ba cạnh bằng nhau", "ba góc 60°"], prerequisites: ["Tam giác cân"], reps: ["DIAGRAM", "TEXT"] },
      { title: "Đường trung trực", summary: "Đường thẳng vuông góc với đoạn thẳng tại trung điểm. Điểm trên đường trung trực cách đều hai đầu đoạn; ngược lại, điểm cách đều hai đầu đoạn thuộc đường trung trực.", keyIdeas: ["trung điểm", "vuông góc", "cách đều", "tính chất đảo"], prerequisites: ["Trung điểm", "Vuông góc"], reps: ["DIAGRAM", "REAL_LIFE"] },
    ],
    objectives: ["Nhận biết tam giác cân, vận dụng tính chất và định lí đảo; nhận biết tam giác đều.", "Nhận biết đường trung trực và vận dụng tính chất theo cả hai chiều.", "Vẽ đường trung trực bằng dụng cụ học tập."],
    vocabulary: [["tam giác cân", "Tam giác có hai cạnh bằng nhau."], ["góc ở đáy", "Hai góc kề cạnh đáy của tam giác cân."], ["tam giác đều", "Tam giác có ba cạnh bằng nhau; mỗi góc bằng 60°."], ["đường trung trực", "Đường vuông góc với đoạn thẳng tại trung điểm của đoạn đó."]],
    mistakes: [
      ["Không nhận ra tam giác cân khi hai góc bằng nhau", "Chỉ nhớ định nghĩa theo cạnh và quên định lí đảo", "Hai góc bằng nhau thì hai cạnh đối diện bằng nhau, vì vậy tam giác là tam giác cân."],
      ["Nhầm đường trung tuyến với đường trung trực", "Chỉ chú ý đi qua trung điểm", "Nhấn mạnh đường trung trực phải vuông góc với đoạn thẳng tại trung điểm."],
      ["Biết MA = MB nhưng không nhận ra M thuộc đường trung trực của AB", "Quên tính chất đảo của đường trung trực", "Điểm cách đều hai đầu đoạn thẳng thuộc đường trung trực của đoạn đó."],
    ],
