...
import { qualityLessons12To19 } from "@/data/lessons/lesson-12-19-quality";
import type { LessonDefinition } from "@/types/lesson";

const lessons: LessonDefinition[] = [
  lesson1, lesson2, lesson3, lesson4, lesson5, lesson6, lesson7,
  lesson8, lesson9, lesson10, lesson11, ...qualityLessons12To19,
];

export function getAllLessons(): LessonDefinition[] {
  return [...lessons].sort((a, b) => a.chapter - b.chapter || a.lessonNumber - b.lessonNumber);
}
...
export function getLessonByKnowledgeNodeId(knowledgeNodeId: string): LessonDefinition | undefined {
