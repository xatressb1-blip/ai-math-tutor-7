...
const DEFINITIONS: CanonicalSkillDefinition[] = [
  ...
  { skillId:"L05_ADV_PERIOD_STRUCTURE", displayName:"Phân tích cấu trúc số thập phân tuần hoàn", lessonNumber:5, tier:"ADVANCED_ONLY", aliases:["Phân tích cấu trúc số thập phân tuần hoàn"] },
  { skillId:"L05_ADV_COUNTEREXAMPLE_PERIODICITY", displayName:"Dùng phản ví dụ để phân biệt vô hạn và tuần hoàn", lessonNumber:5, tier:"ADVANCED_ONLY", aliases:["Dùng phản ví dụ để phân biệt vô hạn và tuần hoàn"] },
  { skillId:"L05_ADV_ROUNDING_DECISION", displayName:"Ra quyết định làm tròn theo độ chính xác", lessonNumber:5, tier:"ADVANCED_ONLY", aliases:["Ra quyết định làm tròn theo độ chính xác"] },
  ...
  { skillId:"L06_ADV_SQRT_ESTIMATION", displayName:"Ước lượng căn bậc hai bằng chặn trên và chặn dưới", lessonNumber:6, tier:"ADVANCED_ONLY", aliases:["Ước lượng căn bậc hai bằng chặn trên và chặn dưới"] },
  { skillId:"L06_ADV_SQRT_VS_EQUATION", displayName:"Phân biệt căn bậc hai số học với nghiệm của phương trình bình phương", lessonNumber:6, tier:"ADVANCED_ONLY", aliases:["Phân biệt căn bậc hai số học với nghiệm của phương trình bình phương"] },
  { skillId:"L06_ADV_SQRT_MODELING", displayName:"Mô hình hóa độ dài bằng căn bậc hai và kiểm soát ước lượng", lessonNumber:6, tier:"ADVANCED_ONLY", aliases:["Mô hình hóa độ dài bằng căn bậc hai và kiểm soát ước lượng"] },
  ...
  { skillId:"L07_ADV_REAL_OPPOSITE_REASONING", displayName:"Suy luận số đối của số thực bằng định nghĩa tổng bằng 0", lessonNumber:7, tier:"ADVANCED_ONLY", aliases:["Suy luận số đối của số thực bằng định nghĩa tổng bằng 0"] },
  { skillId:"L07_ADV_REAL_LINE_ORDER", displayName:"Định vị và so sánh số thực trên trục số bằng bình phương", lessonNumber:7, tier:"ADVANCED_ONLY", aliases:["Định vị và so sánh số thực trên trục số bằng bình phương"] },
  { skillId:"L07_ADV_ABSOLUTE_DISTANCE_MODEL", displayName:"Mô hình hóa khoảng cách trên trục số bằng giá trị tuyệt đối", lessonNumber:7, tier:"ADVANCED_ONLY", aliases:["Mô hình hóa khoảng cách trên trục số bằng giá trị tuyệt đối"] },
  ...
  { skillId:"L08_ADV_SUPPLEMENTARY_STRUCTURE", displayName:"Phản biện kết luận góc kề bù bằng điều kiện cấu trúc", lessonNumber:8, tier:"ADVANCED_ONLY", aliases:["Phản biện kết luận góc kề bù bằng điều kiện cấu trúc"] },
  { skillId:"L08_ADV_BISECTOR_PERPENDICULAR_PROOF", displayName:"Chứng minh hai tia phân giác của hai góc kề bù vuông góc", lessonNumber:8, tier:"ADVANCED_ONLY", aliases:["Chứng minh hai tia phân giác của hai góc kề bù vuông góc"] },
  { skillId:"L08_ADV_VERTICAL_BISECTOR_RELATION", displayName:"Suy luận quan hệ hai tia phân giác của hai góc đối đỉnh", lessonNumber:8, tier:"ADVANCED_ONLY", aliases:["Suy luận quan hệ hai tia phân giác của hai góc đối đỉnh"] },
  ...
  { skillId:"L09_ADV_PARALLEL_CRITERION_VALIDITY", displayName:"Kiểm soát điều kiện của dấu hiệu nhận biết hai đường thẳng song song", lessonNumber:9, tier:"ADVANCED_ONLY", aliases:["Kiểm soát điều kiện của dấu hiệu nhận biết hai đường thẳng song song"] },
  { skillId:"L09_ADV_PARALLEL_CONVERSE_DIRECTION", displayName:"Phân biệt chiều thuận và chiều đảo trong suy luận song song", lessonNumber:9, tier:"ADVANCED_ONLY", aliases:["Phân biệt chiều thuận và chiều đảo trong suy luận song song"] },
  { skillId:"L09_ADV_PARALLEL_MULTI_STEP_PROOF", displayName:"Chứng minh song song qua biến đổi góc trung gian", lessonNumber:9, tier:"ADVANCED_ONLY", aliases:["Chứng minh song song qua biến đổi góc trung gian"] },
  ...
  { skillId:"L10_ADV_EUCLID_UNIQUENESS", displayName:"Suy luận tính duy nhất từ tiên đề Euclid", lessonNumber:10, tier:"ADVANCED_ONLY", aliases:["Suy luận tính duy nhất từ tiên đề Euclid"] },
  { skillId:"L10_ADV_PARALLEL_PROPERTY_DIRECTION", displayName:"Kiểm soát chiều suy luận từ song song đến quan hệ góc", lessonNumber:10, tier:"ADVANCED_ONLY", aliases:["Kiểm soát chiều suy luận từ song song đến quan hệ góc"] },
  { skillId:"L10_ADV_PERPENDICULAR_TRANSFER_PROOF", displayName:"Chứng minh vuông góc với đường song song bằng quan hệ góc", lessonNumber:10, tier:"ADVANCED_ONLY", aliases:["Chứng minh vuông góc với đường song song bằng quan hệ góc"] },
  ...
  { skillId:"L11_ADV_GIVEN_GOAL_PROOF_MAP", displayName:"Lập bản đồ giả thiết–kết luận–chuỗi chứng minh", lessonNumber:11, tier:"ADVANCED_ONLY", aliases:["Lập bản đồ giả thiết–kết luận–chuỗi chứng minh"] },
  { skillId:"L11_ADV_CIRCULAR_REASONING_DETECTION", displayName:"Phát hiện và sửa chứng minh vòng tròn", lessonNumber:11, tier:"ADVANCED_ONLY", aliases:["Phát hiện và sửa chứng minh vòng tròn"] },
  { skillId:"L11_ADV_CONVERSE_ERROR_DETECTION", displayName:"Phát hiện lỗi mệnh đề đảo và kiểm tra chiều đảo", lessonNumber:11, tier:"ADVANCED_ONLY", aliases:["Phát hiện lỗi mệnh đề đảo và kiểm tra chiều đảo"] },
  ...
  { skillId:"L12_ADV_TRIANGLE_ANGLE_FEASIBILITY", displayName:"Phản biện cấu hình góc tam giác bằng định lí tổng ba góc", lessonNumber:12, tier:"ADVANCED_ONLY", aliases:["Phản biện cấu hình góc tam giác bằng định lí tổng ba góc"] },
  { skillId:"L12_ADV_EXTERIOR_ANGLE_DERIVATION", displayName:"Chứng minh định lí góc ngoài từ tổng góc và kề bù", lessonNumber:12, tier:"ADVANCED_ONLY", aliases:["Chứng minh định lí góc ngoài từ tổng góc và kề bù"] },
  { skillId:"L12_ADV_EXTERIOR_ANGLE_CONSTRAINT", displayName:"Giải ràng buộc góc tam giác bằng góc ngoài và kiểm chứng kép", lessonNumber:12, tier:"ADVANCED_ONLY", aliases:["Giải ràng buộc góc tam giác bằng góc ngoài và kiểm chứng kép"] },
  ...
  { skillId:"L13_ADV_CCC_VERTEX_CORRESPONDENCE", displayName:"Xác định tương ứng đỉnh từ ba cặp cạnh", lessonNumber:13, tier:"ADVANCED_ONLY", aliases:["Xác định tương ứng đỉnh từ ba cặp cạnh"] },
  { skillId:"L13_ADV_CCC_PROOF_CHAIN", displayName:"Lập chuỗi chứng minh c.c.c. đến góc tương ứng", lessonNumber:13, tier:"ADVANCED_ONLY", aliases:["Lập chuỗi chứng minh c.c.c. đến góc tương ứng"] },
  { skillId:"L13_ADV_CCC_INSUFFICIENT_EVIDENCE", displayName:"Phát hiện thiếu dữ kiện trong chứng minh c.c.c.", lessonNumber:13, tier:"ADVANCED_ONLY", aliases:["Phát hiện thiếu dữ kiện trong chứng minh c.c.c."] },
  ...
  { skillId:"L14_ADV_SAS_INCLUDED_ANGLE", displayName:"Nhận diện góc xen giữa và áp dụng c.g.c. đúng điều kiện", lessonNumber:14, tier:"ADVANCED_ONLY", aliases:["Nhận diện góc xen giữa và áp dụng c.g.c. đúng điều kiện"] },
  { skillId:"L14_ADV_ASA_INCLUDED_SIDE", displayName:"Nhận diện cạnh xen giữa và lập chuỗi g.c.g.", lessonNumber:14, tier:"ADVANCED_ONLY", aliases:["Nhận diện cạnh xen giữa và lập chuỗi g.c.g."] },
  { skillId:"L14_ADV_CONGRUENCE_CRITERIA_AUDIT", displayName:"Phản biện tiêu chuẩn bằng nhau c.g.c. và g.c.g.", lessonNumber:14, tier:"ADVANCED_ONLY", aliases:["Phản biện tiêu chuẩn bằng nhau c.g.c. và g.c.g."] },
  ...
  { skillId:"L15_ADV_RIGHT_TRIANGLE_CRITERIA_SELECTION", displayName:"Phân biệt ba trường hợp bằng nhau cơ bản của tam giác vuông", lessonNumber:15, tier:"ADVANCED_ONLY", aliases:["Phân biệt ba trường hợp bằng nhau cơ bản của tam giác vuông"] },
  { skillId:"L15_ADV_RIGHT_TRIANGLE_HYPOTENUSE_LEG", displayName:"Chứng minh bằng trường hợp cạnh huyền–cạnh góc vuông", lessonNumber:15, tier:"ADVANCED_ONLY", aliases:["Chứng minh bằng trường hợp cạnh huyền–cạnh góc vuông"] },
  { skillId:"L15_ADV_RIGHT_TRIANGLE_PREREQUISITE_AUDIT", displayName:"Kiểm tra điều kiện tiên quyết của các trường hợp tam giác vuông", lessonNumber:15, tier:"ADVANCED_ONLY", aliases:["Kiểm tra điều kiện tiên quyết của các trường hợp tam giác vuông"] },
  ...
  { skillId:"L16_ADV_ISOSCELES_CONVERSE_PROOF", displayName:"Vận dụng định lí đảo của tam giác cân theo đúng cạnh đối diện", lessonNumber:16, tier:"ADVANCED_ONLY", aliases:["Vận dụng định lí đảo của tam giác cân theo đúng cạnh đối diện"] },
  { skillId:"L16_ADV_PERP_BISECTOR_BIDIRECTIONAL", displayName:"Kiểm soát hai chiều của tính chất đường trung trực", lessonNumber:16, tier:"ADVANCED_ONLY", aliases:["Kiểm soát hai chiều của tính chất đường trung trực"] },
  { skillId:"L16_ADV_PERP_BISECTOR_TWO_POINTS_PROOF", displayName:"Chứng minh đường trung trực từ hai điểm cách đều", lessonNumber:16, tier:"ADVANCED_ONLY", aliases:["Chứng minh đường trung trực từ hai điểm cách đều"] },
  ...
  { skillId:"L17_ADV_DATA_TYPE_CLASSIFICATION", displayName:"Phân loại dữ liệu số, thứ bậc và danh nghĩa theo bản chất", lessonNumber:17, tier:"ADVANCED_ONLY", aliases:["Phân loại dữ liệu số, thứ bậc và danh nghĩa theo bản chất"] },
  { skillId:"L17_ADV_REPRESENTATIVE_SAMPLE_REASONING", displayName:"Đánh giá tính đại diện, thiên lệch mẫu và phạm vi suy rộng", lessonNumber:17, tier:"ADVANCED_ONLY", aliases:["Đánh giá tính đại diện, thiên lệch mẫu và phạm vi suy rộng"] },
  { skillId:"L17_ADV_SURVEY_BIAS_OVERGENERALIZATION", displayName:"Phát hiện câu hỏi dẫn dắt, mẫu thuận tiện và kết luận vượt phạm vi", lessonNumber:17, tier:"ADVANCED_ONLY", aliases:["Phát hiện câu hỏi dẫn dắt, mẫu thuận tiện và kết luận vượt phạm vi"] },
  ...
  { skillId:"L18_ADV_PIE_TOTAL_CONSISTENCY", displayName:"Kiểm định tổng 100% và suy ra phần còn thiếu của biểu đồ quạt tròn", lessonNumber:18, tier:"ADVANCED_ONLY", aliases:["Kiểm định tổng 100% và suy ra phần còn thiếu của biểu đồ quạt tròn"] },
  { skillId:"L18_ADV_PIE_REVERSE_COUNT", displayName:"Suy ngược tổng thể và phân bổ số lượng từ tỉ lệ biểu đồ quạt tròn", lessonNumber:18, tier:"ADVANCED_ONLY", aliases:["Suy ngược tổng thể và phân bổ số lượng từ tỉ lệ biểu đồ quạt tròn"] },
  { skillId:"L18_ADV_PIE_PERCENTAGE_POINT_REASONING", displayName:"Phân biệt điểm phần trăm, phần trăm tăng tương đối và số lượng", lessonNumber:18, tier:"ADVANCED_ONLY", aliases:["Phân biệt điểm phần trăm, phần trăm tăng tương đối và số lượng"] },
  ...
  { skillId:"L19_ADV_LINE_READ_TREND_LIMIT", displayName:"Đọc điểm dữ liệu, mô tả xu hướng và tránh suy rộng quá mức", lessonNumber:19, tier:"ADVANCED_ONLY", aliases:["Đọc điểm dữ liệu, mô tả xu hướng và tránh suy rộng quá mức"] },
  { skillId:"L19_ADV_LINE_CONSTRUCT_MULTI_SCALE", displayName:"Thiết kế biểu đồ đoạn thẳng nhiều đường và chọn thang đo", lessonNumber:19, tier:"ADVANCED_ONLY", aliases:["Thiết kế biểu đồ đoạn thẳng nhiều đường và chọn thang đo"] },
  { skillId:"L19_ADV_MISLEADING_LINE_SCALE", displayName:"Phát hiện biểu đồ đoạn thẳng gây hiểu nhầm do thang đo", lessonNumber:19, tier:"ADVANCED_ONLY", aliases:["Phát hiện biểu đồ đoạn thẳng gây hiểu nhầm do thang đo"] },
