...
const DEFINITIONS: CanonicalSkillDefinition[] = [
  ...
  { skillId:"L17_ADV_SIDE_TO_OPPOSITE_ANGLE_ORDER", displayName:"Suy luận từ thứ tự cạnh sang thứ tự góc đối diện", lessonNumber:17, tier:"ADVANCED_ONLY", aliases:["Suy luận từ thứ tự cạnh sang thứ tự góc đối diện"] },
  { skillId:"L17_ADV_ANGLE_TO_OPPOSITE_SIDE_ORDER", displayName:"Suy luận từ thứ tự góc sang thứ tự cạnh đối diện", lessonNumber:17, tier:"ADVANCED_ONLY", aliases:["Suy luận từ thứ tự góc sang thứ tự cạnh đối diện"] },
  { skillId:"L17_ADV_CROSS_TRIANGLE_BRIDGE_REASONING", displayName:"So sánh khác tam giác bằng chuỗi cầu nối cạnh–góc", lessonNumber:17, tier:"ADVANCED_ONLY", aliases:["So sánh khác tam giác bằng chuỗi cầu nối cạnh–góc"] },
