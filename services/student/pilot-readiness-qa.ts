import { getCanonicalSkillDefinitions, sameCanonicalSkill } from "@/services/student/canonical-skill-registry";
...
export function runPilotReadinessQa(): PilotReadinessCheck[] {
  ...
  const freshReadiness = buildSemesterRevisionPlan(emptyBrain()).readinessScore;
